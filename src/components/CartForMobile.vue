  ...
  <div class="flex h-full flex-col">
    ...
    <div class="flex-1 bg-neutral-100">
        ...
        <div class="relative">
          <v-form class="relative w-full" @submit.prevent="addCartItem">
            <input
              ...
              type="text"
              class="block w-full text-ellipsis rounded-xl border border-neutral-300 px-4 py-2 pl-12 text-lg outline-black placeholder:text-gray-300"
              :class="
      ...
      >
        ...
        >
          <span>Готово</span>
          <!-- <span class="material-symbols-outlined self-center font-medium"
            >done</span
          > -->
        </button>
      </div>
